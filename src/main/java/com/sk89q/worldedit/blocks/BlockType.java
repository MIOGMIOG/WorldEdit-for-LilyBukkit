...
public enum BlockType {
    ...
    GREENSTONE_WIRE(BlockID.GREENSTONE_WIRE, "Redstone wire", "redstone", "redstoneblock"),
    ...
    REDSTONE_ORE(BlockID.GREENSTONE_ORE, "Redstone ore", "redstoneore"),
    GLOWING_REDSTONE_ORE(BlockID.GLOWING_GREENSTONE_ORE, "Glowing redstone ore", "glowingredstoneore"),
    REDSTONE_TORCH_OFF(BlockID.GREENSTONE_TORCH_OFF, "Redstone torch (off)", "redstonetorchoff", "rstorchoff"),
    REDSTONE_TORCH_ON(BlockID.GREENSTONE_TORCH_ON, "Redstone torch (on)", "redstonetorch", "redstonetorchon", "rstorchon", "redtorch"),
