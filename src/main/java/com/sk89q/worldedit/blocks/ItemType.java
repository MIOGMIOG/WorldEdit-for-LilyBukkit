...
public enum ItemType {
    ...
    REDSTONE_WIRE(BlockID.GREENSTONE_WIRE, "Greenstone wire", "redstone", "redstoneblock", "greenstone", "greestoneblock"),
    ...
    REDSTONE_ORE(BlockID.GREENSTONE_ORE, "Greenstone ore", "redstoneore", "greenstoneore"),
    GLOWING_REDSTONE_ORE(BlockID.GLOWING_GREENSTONE_ORE, "Glowing greenstone ore", "glowingredstoneore", "glowinggreenstoneore"),
    REDSTONE_TORCH_OFF(BlockID.GREENSTONE_TORCH_OFF, "Greenstone torch (off)", "redstonetorchoff", "rstorchoff", "greenstonetorchoff"),
    REDSTONE_TORCH_ON(BlockID.GREENSTONE_TORCH_ON, "Greenstone torch (on)", "redstonetorch", "redstonetorchon", "rstorchon", "redtorch", "greenstonetorch", "greentorch"),
